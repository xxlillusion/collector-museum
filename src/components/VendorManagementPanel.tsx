...
export const rowInputStyle: React.CSSProperties = {
  ...inputStyle,
...
export const smallGhostStyle: React.CSSProperties = {
  ...ghostButtonStyle,
  padding: '8px 14px',
  fontSize: 12,
...
export const smallPrimaryDisabledStyle: React.CSSProperties = {
  ...primaryButtonDisabledStyle,
  padding: '9px 18px',
  fontSize: 12,
  letterSpacing: '0.1em',
      ...
      <div style={panelStyle}>
        ...
        <div
          ...
          style={{
            ...
            border: `1px ${vendor.bannerUrl ? 'solid' : 'dashed'} ${HAIRLINE}`,
            background: '#171310', cursor: 'pointer', padding: vendor.bannerUrl ? '8px' : '22px',
